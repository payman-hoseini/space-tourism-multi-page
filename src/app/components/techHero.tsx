...
export default function TechHero({ File } : {File : PageFile}){
    ...
    return (
        <div className="lg:mt-6 md:mt-16 lg:ml-40  h-[65%] grid lg:grid-cols-2  lg:gap-x-8">
            <div className="flex lg:flex-row md:flex-col mx-10 lg:mx-0 md:order-last lg:order-first items-center">
                <div className="lg:space-y-10 lg:space-x-0 md:space-x-10 md:mt-8 lg:mr-16">
                ...
                <div className="md:mt-10 lg:mt-0 md:text-center lg:text-start">
